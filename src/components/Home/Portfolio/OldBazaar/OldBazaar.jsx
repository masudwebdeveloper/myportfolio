...
const OldBazaar = () => {
    const projectImg = [
        {
            id: 1,
            img: 'https://i.ibb.co/ch2dcVD/old-bazaar-home-page.png'
        },
        {
            id: 2,
            img: 'https://i.ibb.co/gMySkvQ/old-bazar-details-page.png'
        },
        {
            id: 3,
            img: 'https://i.ibb.co/gWjYCMq/old-bazar-blog-page.png'
        },
    ]
    return (
