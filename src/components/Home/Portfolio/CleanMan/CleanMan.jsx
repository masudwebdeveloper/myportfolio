...
const CleanMan = () => {
    const projectImg = [
        {
            id: 1,
            img: 'https://i.ibb.co/SQg2WrN/cleaning-man-home-page.png'
        },
        {
            id: 2,
            img: 'https://i.ibb.co/khM1x16/cleaning-man-service-page.png'
        },
        {
            id: 3,
            img: 'https://i.ibb.co/b34qn2V/cleaning-man-login-page.png'
        },
    ]
    return (
                ...
                <div>
                    <ul className='flex gap-x-5 my-8 '>
                        <li className='btn btn-warning btn-sm text-black hover:btn-success hover:text-white'>
                            <a href='https://cleaning-man.web.app/' target='_blank'>Live Link</a>
                        </li>
                        ...
                        <li className='btn btn-warning btn-sm text-black hover:btn-success'>
                            <a href='https://github.com/masudwebdeveloper/cleaning-man-client' target='_blank'>GitHub Client</a>
                        </li>
                    </ul>
                </div>
            </div>
