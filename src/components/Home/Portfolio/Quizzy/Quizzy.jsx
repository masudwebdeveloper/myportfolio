...
const Quizzy = () => {
    const projectImg = [
        {
            id: 1,
            img: 'https://i.ibb.co/mRWG8N7/quizzy-home-page.png'
        },
        {
            id: 2,
            img: 'https://i.ibb.co/z7GZZZx/quizzy-blog-page.png'
        },
        {
            id: 3,
            img: 'https://i.ibb.co/6yqkYTn/quizzy-page.png'
        },
    ]
    return (
                ...
                <div>
                    <ul className='flex gap-x-5 my-8 '>
                        <li className='btn btn-warning btn-sm text-black hover:btn-success hover:text-white'>
                            <a href='https://quizzy-program.netlify.app/home' target='_blank'>Live Link</a>
                        </li>
                        ...
                        <li className='btn btn-warning btn-sm text-black hover:btn-success'>
                            <a href='###' target='_blank'>GitHub Client</a>
                        </li>
                    </ul>
                </div>
            </div>
