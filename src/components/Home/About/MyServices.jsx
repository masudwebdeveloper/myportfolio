...
const MyServices = () => {
    ...
    return (
        <div className='px-3 lg:px-24 mb-32'>
            <div className='mb-10 text-center lg:text-start'>
                <h3 className='text-xl'>Services i offer to my clients</h3>
                <h1 className='text-3xl lg:text-5xl text-white'>My Services</h1>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
                <div className="card bg-neutral text-neutral-content hover:border-b-2 border-green-500">
                    <div className="card-body items-center text-center text-gray-300">
