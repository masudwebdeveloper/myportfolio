  ...
  return (
    <div className="flex">
      ...
      <div
        className={`${
          open ? "w-72" : "w-20"
        } h-screen bg-[#131720] relative p-5 pt-8 duration-300 hidden lg:block`}
      >
        <div
          onClick={() => setOpen(!open)}
          className="bg-gray-500 -right-4 rounded-full top-9 z-50 w-7 h-7 flex items-center justify-center absolute cursor-pointer"
        >
          <MdOutlineKeyboardArrowLeft
            className={`text-xl text-white ${!open && "rotate-180"}`}
          ></MdOutlineKeyboardArrowLeft>
        </div>
        <div className="group flex pl-2 gap-x-4 items-center">
          <div className="flex rounded-full">
            <span className={`text-xl text-white cursor-pointer duration-500`}>
              {icon}
            </span>
            {/* <AiFillHome
          ...
          <h1
            className={`text-2xl duration-300 font-semibold origin-left text-white ${
              !open && "scale-0"
            }`}
          >
            Portfolio
        ...
        <ul className="flex flex-col gap-x-4 items-center mt-5">
          <li
            className={`${
              !open && "flex "
            } group w-full hover:bg-gray-50 py-1 mt-3 hover:border-b-4 border-b-4 border-[#131720] px-[10px]  hover:border-green-500 duration-300 ${
              !open && "rounded-full hover:border-white"
            }`}
          >
            <NavLink to="/about" className="flex items-center gap-x-4">
              ...
              <h1
                className={`text-xl text-white duration-300 font-semibold origin-left group-hover:text-black ${
                  !open && "scale-0"
                }`}
              >
                About
          ...
          <li
            className={`group w-full transition hover:bg-gray-200 py-1 mt-3 hover:border-b-4 border-b-4 border-[#131720] px-[10px]  hover:border-green-500 duration-300 ${
              !open && "rounded-full hover:border-white"
            }`}
          >
            <NavLink to="/resume" className="flex items-center gap-x-4">
              <div>
                <FaHeartbeat className="text-xl mt-2 text-white cursor-pointer duration-500 group-hover:text-black"></FaHeartbeat>
              </div>
              <h1
                className={`text-xl duration-300 font-semibold origin-left text-white group-hover:text-black ${
                  !open && "scale-0"
                }`}
              >
                Resume
          ...
          >
            <NavLink to="/portfolio" className="flex items-center gap-x-4">
              <div>
                <FaBriefcase className="text-xl mt-1 text-white cursor-pointer duration-500 group-hover:text-black"></FaBriefcase>
              </div>
              <h1
                className={`text-xl duration-300 font-semibold origin-left text-white group-hover:text-black ${
                  !open && "scale-0"
          ...
          <li
            className={`group w-full transition hover:bg-gray-300 py-1 mt-3 hover:border-b-4 border-b-4 border-[#131720] px-[10px]  hover:border-green-500 duration-300 ${
              !open && "rounded-full hover:border-white"
            }`}
          >
            <NavLink to="/contact" className="flex items-center gap-x-4">
              <div>
                <TiContacts className="text-xl mt-1 text-white cursor-pointer duration-500 rounded-full group-hover:text-black"></TiContacts>
              </div>
              <h1
                className={`text-xl duration-300 font-semibold origin-left text-white group-hover:text-black ${
                  !open && "scale-0"
          ...
          >
            <NavLink to="/blog" className="flex items-center gap-x-4">
              <div>
                <FaBloggerB className="text-xl mt-1 text-white cursor-pointer duration-500 rounded-full group-hover:text-black"></FaBloggerB>
              </div>
              <h1
                className={`text-xl duration-300 font-semibold origin-left text-white group-hover:text-black ${
                  !open && "scale-0"
      ...
      <div className="relative">
        <div className="min-h-screen bg-opacity-60 bg-black">
            ...
            <div className="z-10 grid gap-10 items-center justify-between grid-cols-1 lg:grid-cols-2 p-4">
              <div className="lg:pl-40 text-center">
                ...
                <p className="text-justify">
                  I am a Passionate MERN Stack web developer. My name is Masud
                  Rana. I have acquired complete web development knowledge from
                  Programming Hero with Jhanker Mahbub.
                </p>
                <a
                  href="##https://drive.google.com/file/d/1NZtlO0XnwFsIkr1loJcsjt-FloaKXme0/view?usp=sharing"
                  target="_blank"
                >
                  <button
                    type="button"
              ...
              <div title="Masud Rana" className="mt-14 rounded">
                <img
                  alt="profile"
                  src="https://i.ibb.co/qdHXDs7/masud-remove-bg.png"
                  className="brightness-50 hover:brightness-100 duration-500 lg:h-[540px] rounded-lg shadow-2xl bg-opacity-20"
                />
              </div>
            </div>
          </div>
          <div className="fixed bottom-10 z-50">
            ...
            <a href="https://www.linkedin.com/in/mrmasudrana/" target="_blank">
            ...
            <a href="https://github.com/masudwebdeveloper" target="_blank">
